...
class Ratios:
   ...
   def CreateGraphRatio(FundamentalDataFrame, Column, Operation, PreSymbol, AfterSymbol):
       ...
       temp.loc[temp['Result'] != "nan",["Result"]] =PreSymbol+temp['Result']+AfterSymbol
       ...
       temp.RoundedResult =  temp.RoundedResult.round(0)
       ...
       temp.loc[temp['RoundedResult'] != str(np.nan), ['RoundedResult']] = PreSymbol+temp['RoundedResult']+AfterSymbol
