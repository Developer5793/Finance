...
class Table():
    ...
    def CreateRatioTable(self,Operation,PreSymbol,AfterSymbol):

       ObjectTableFrame = self.df[["fiscalDateEnding","Divison","Result"]].copy()
       ...
       if Operation == "Multiple":
         ObjectTableFrame['PercentageRateDelta'] =  ObjectTableFrame["DivisionRateDelta"]
       else:
       ...
       ObjectTableFrame.loc[ObjectTableFrame['Marker'] == "-",["PercentageRateDelta"]] = ObjectTableFrame['PercentageRateDelta']*(-1)

       ObjectTableFrame.PercentageRateDelta =ObjectTableFrame.PercentageRateDelta.astype(str)
       ObjectTableFrame.loc[ObjectTableFrame['Marker'] == "+",["PercentageRateDelta"]] = ObjectTableFrame['Marker']+PreSymbol+ObjectTableFrame['PercentageRateDelta']+AfterSymbol
       ObjectTableFrame.loc[ObjectTableFrame['Marker'] == "-",["PercentageRateDelta"]] = PreSymbol+"-"+ObjectTableFrame['PercentageRateDelta']+AfterSymbol

       ObjectTableFrame.loc[ObjectTableFrame['PercentageRateDelta'] == "nan",["PercentageRateDelta"]] = "N/A"

       ObjectTableCleaned = ObjectTableFrame[["fiscalDateEnding",'Result','PercentageRateDelta']].copy()
