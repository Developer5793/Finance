                        ...
                        dbc.Row([
                         ...
                         dbc.Row([
                          ...
                          dbc.Row([
                             ...
                             dbc.Col(HeaderList[14], width={"size": 3}),

                             ]),
                          dbc.Row([
                             dbc.Col(ElementList[12], width={"size": 3,"offset": 1}),
                             dbc.Col(ElementList[13], width={"size": 3}),
                             dbc.Col(ElementList[14],width={"size": 3}),

                          ]),
                          dbc.Row([
                             dbc.Col(HeaderList[15],width={"size": 3,"offset":1}),
                             dbc.Col(HeaderList[16],width={"size": 3}),

                             ]),
                          dbc.Row([
                             dbc.Col(ElementList[15],width={"size": 3,"offset": 1}),
                             dbc.Col(ElementList[16],width={"size": 3}),
...
["RetunOnEquityStateButton",["netIncomeAverage"],["totalShareholderEquity"], "Return on Equity: ", ObjectList[10]],
["ReturnOnAssetsStateButton",["netIncomeAverage"],["totalAssets"], "Return on Assets: ", ObjectList[11]],
["ReturnOnSalesStateButton",["ebit"],["totalRevenue"], "Return on Sales (EBIT-Margin): ", ObjectList[12]],
["OperatingProfitMarginStateButton",["operatingIncome"],["totalRevenue"], "Operating Profit Margin: ", ObjectList[13]],
["ProfitMarginStateButton",["netIncome"],["totalRevenue"], "Profit Margin: ", ObjectList[14]],
["InterestCoverageRatioStateButton",["ebit"],["interestExpense"], "Interest Coverage Ratio: ", ObjectList[15]],
["CashFlowToRevenuesStateButton",["operatingCashflow"],["totalRevenue"], "Operating Cashflow to Sales Ratio: ", ObjectList[16],
 ]
]
