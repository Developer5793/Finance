...
def GetSelectedStock(cell):
  if cell and cell['colId'] == "SYMBOL":
    ...
    DictPriceInformationData = Receive_Dicts.ReceiveWeeklyPriceInformation(Tag)

    DataObject = Dataprocessing.CreateDataFrames 
    FundamentalDataFrame = DataObject.CreateFundamentalDataFrame(DictBalanceSheetData,DictIncomestatementData,DictCashFlowStatementData)

    return DictCompanyOverview, DictBalanceSheetData, DictIncomestatementData, DictCashFlowStatementData, FundamentalDataFrame, DictPriceInformationData, "http://127.0.0.1:8050/stockbasics"   
